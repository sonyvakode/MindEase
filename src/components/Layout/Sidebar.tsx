...
const menuItems = [
  ...
  { id: "chatbot", icon: MessageSquare, label: "AI Support" },
...
export default function Sidebar({ activeTab, setActiveTab }: SidebarProps) {
  ...
  return (
    <motion.aside
      ...
      className="fixed left-0 top-0 h-screen w-20 lg:w-64 bg-black/20 backdrop-blur-3xl border-r border-white/5 p-4 flex flex-col z-50"
    >
      <div className="flex items-center gap-3 mb-10 px-2 cursor-pointer" onClick={() => setActiveTab("landing")}>
        ...
        <h1 className="text-xl font-bold font-sans hidden lg:block tracking-tight text-white">MindEase</h1>
      </div>
