...
export default function Landing({ onNavigate, theme, onToggleTheme }: LandingProps) {
  ...
  return (
    <div className={cn("min-h-screen relative overflow-x-hidden flex flex-col items-center w-full transition-colors duration-300", theme === "light" ? "light bg-[#F3F6F5] text-slate-900" : "bg-[#040D0E] text-white")}>
      {/* Navbar */}
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 sm:px-8 py-4 sm:py-6 max-w-7xl mx-auto w-full bg-dark-bg/50 backdrop-blur-xl border-b border-white/5 sm:bg-transparent sm:backdrop-blur-none sm:border-none">
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="w-9 h-9 sm:w-10 sm:h-10 purple-gradient rounded-xl flex items-center justify-center shadow-lg shadow-indigo-500/20">
        ...
        <div className="flex items-center gap-4 sm:gap-6 lg:gap-10 text-white/50 text-xs sm:text-sm font-medium ml-auto">
          ...
          }} className="hover:text-indigo-500 transition-colors">About</button>
          
          <button onClick={() => handleNavigateWithAuth("community")} className="hover:text-indigo-500 transition-colors">Community</button>

          <button onClick={onToggleTheme} className="hover:text-indigo-500 p-1.5 rounded-xl bg-white/5 hover:bg-white/10 transition-colors flex items-center justify-center text-white" title="Toggle Theme">
            {theme === "light" ? <Moon className="w-4 h-4 text-indigo-600 sm:w-5 sm:h-5 animate-pulse" /> : <Sun className="w-4 h-4 text-yellow-400 sm:w-5 sm:h-5 animate-spin-slow" />}
          </button>
          ...
          {user ? (
            ...
            <button 
              ...
              className="purple-gradient text-white px-4 sm:px-6 py-2 rounded-xl text-[10px] sm:text-xs font-bold shadow-lg shadow-indigo-500/20 hover:scale-105 transition-all"
            >
              Sign In
            </button>
          )}
            ...
            >
              ...
              <form onSubmit={handleEmailAuth} className="space-y-4 mb-6">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      placeholder="name@example.com"
                       className="w-full bg-white/5 border border-white/10 rounded-xl py-3 pl-12 pr-4 text-sm text-white placeholder:text-white/10 focus:outline-none focus:border-indigo-500/30 transition-colors"
                    />
                  </div>
                </div>
                ...
                <button 
                  ...
                  className="w-full purple-gradient py-3.5 rounded-xl font-bold text-white shadow-lg shadow-indigo-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 group disabled:opacity-50 disabled:hover:scale-100"
                >
                  {isSubmitting ? (
      ...
      {/* Hero Section */}
      <section className="relative z-10 px-4 sm:px-8 pt-20 sm:pt-28 lg:pt-40 pb-2 sm:pb-16 max-w-7xl mx-auto w-full flex flex-col lg:flex-row items-center gap-10 sm:gap-16 lg:gap-16">
        <motion.div
        ...
        >
          <h1 className="text-4xl xs:text-5xl sm:text-7xl lg:text-8xl font-bold tracking-tighter mb-4 lg:mb-8 leading-[0.95] sm:leading-[0.85]">
            You are<br />
            <span className={cn(theme === "light" ? "text-indigo-600" : "text-indigo-400")}>not alone</span>
          </h1>
          <p className="max-w-md mx-auto lg:mx-0 text-base sm:text-lg text-white/80 font-medium mb-6 lg:mb-10 leading-relaxed font-sans px-2 sm:px-0">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 px-4 sm:px-0">
            <button 
              ...
              className="w-full sm:w-auto purple-gradient px-10 py-4 rounded-xl font-bold shadow-2xl shadow-indigo-500/30 hover:scale-105 active:scale-95 transition-all text-sm sm:text-base"
            >
              Get Started
            </button>
            <button 
        ...
        >
          <div className="relative z-10 w-full aspect-square max-w-[550px] mx-auto overflow-hidden rounded-[3rem] p-1 bg-gradient-to-b from-indigo-500/20 to-transparent border border-white/10 shadow-[0_0_100px_rgba(99,102,241,0.15)]">
             <img 
                src="https://images.unsplash.com/photo-1545205597-3d9d02c29597?w=1000&auto=format&fit=crop&q=80" 
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[110%] h-[110%] bg-indigo-500/10 rounded-full blur-[120px] -z-10" />
        </motion.div>
      </section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          {[
            ...
            <motion.div
              ...
              className="glass-card p-6 flex flex-col items-center text-center group cursor-pointer hover:border-indigo-500/30"
            >
              ...
              <h3 className="text-xs sm:text-sm font-bold mb-2 text-white">{f.title}</h3>
              <p className="text-xs text-white/50 leading-relaxed font-semibold mt-1">{f.desc}</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section id="about-us" className="relative z-10 px-8 py-6 sm:py-32 max-w-7xl mx-auto w-full border-t border-white/5">
        <div className="max-w-3xl mx-auto text-center space-y-3 sm:space-y-8">
          <h2 className="text-4xl font-bold tracking-tight text-white italic">About <span className={cn(theme === "light" ? "text-indigo-600" : "text-indigo-400")}>MindEase</span></h2>
          <p className="text-white/80 font-medium text-base sm:text-lg leading-relaxed font-sans">
      ...
      <section className="relative z-10 px-8 py-6 sm:py-20 w-full max-w-7xl mx-auto">
        <GlassCard className="purple-gradient/10 border-indigo-500/10 text-center py-6 sm:py-12">
           <p className="text-lg lg:text-xl font-serif italic text-indigo-100">
      ...
      <footer className="relative z-10 w-full border-t border-white/5 pt-8 pb-32 px-8 flex flex-col items-center gap-6">
        <div className="flex items-center gap-3">
          <Heart className={cn("w-5 h-5 fill-current", theme === "light" ? "text-indigo-600" : "text-indigo-400")} />
